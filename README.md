...
- `intro_to_LLMs.ipynb` — interactive Jupyter notebook with hands-on experiments

- `llm_helpers.py` — helper functions for plotting, model utilities, and visualization
...
- 🤗 Hugging Face model loading and interaction
